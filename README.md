...
## Демо-метрики (только для показа научному руководителю)

Числа ниже являются демонстрационными целевыми значениями для презентации структуры проекта и ожидаемого результата.
Это не финальные защищаемые результаты. Перед предзащитой их нужно заменить на значения из полностью воспроизводимых прогонов.
